# **Prueba Tecnica Booking**

## Introduction

Booking: Founded in 1996 in Amsterdam, Booking.com has grown from a small Dutch start-up to one of the world’s leading digital travel companies. 
Part of Booking Holdings Inc. (NASDAQ: BKNG), Booking.com’s mission is to make it easier for everyone to experience the world.
...
```git clone https://github.com/jpra1993/booking.git```
